package com.multipolar.bootcamp.loggingexercise.service;

import com.multipolar.bootcamp.loggingexercise.domain.AccessLog;
import com.multipolar.bootcamp.loggingexercise.repository.AccessLogRepository;
...
public class KafkaProductService {
    ...
    @KafkaListener(topics = "access-logs-exercise")
